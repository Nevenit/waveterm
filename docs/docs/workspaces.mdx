...
To reorder saved workspaces, open the Workspace Switcher and drag a workspace to its new position. The order is saved and also determines which workspace is selected by each numbered workspace shortcut.
